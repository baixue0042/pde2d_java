...
public class Model2  extends Model{
	...
	public void setHSS(){
		n_chemical = 3;
		hss = new double[n_chemical]; hss[0] = fixpoint(); hss[1] = k_R[8]/k_R[9]-hss[0]; hss[2] = k_R[5]/k_R[6]*hss[0];
	}
	@ Override
	public double[] f_R(double[] u){
		...
		dudt[1] = -dudt[0]+k_R[8]-k_R[9]*I;
		dudt[2] = k_R[5]*A - k_R[6]*F;
		return dudt;
	}
	@ Override
	public double fss(double x){
		return hill(x,k_R[0],k_R[1],k_R[2],3)*(k_R[8]/k_R[9]-x) - hill(k_R[5]/k_R[6]*x,k_R[3],k_R[4],1,1)*x;
	}
}
